...
using Fluxys.Puma.IdentityProvider.STS.Identity.Helpers.Localization;
using Fluxys.Puma.IdentityProvider.STS.Identity.ViewModels.Manage;

namespace Fluxys.Puma.IdentityProvider.STS.Identity.Controllers
{    
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Fluxys.Puma.IdentityProvider.STS.Identity"),
